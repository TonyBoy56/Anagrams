...
#### _C# Testting practice for Epicodus_, _Mar. 3, 2020_

#### By _**Zakkrey Short, Antonio Cruz**_

## Description

_This application translates a user input string into an anagram!

## Specifications:

| Specification | Example Input | Example Output |
| ------------- |:-------------:| -------------------:|
| Arrange original word to a different word | 
